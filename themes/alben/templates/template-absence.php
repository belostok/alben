			...
			<div class="entry-content">
				<?php if ( ! empty( $images ) ) : ?>
					<div class="alben-absence-slider">
						<div class="alben-absence-slider__slider js-absence-slider relative">
							<div class="alben-absence-slider__slider-wrapper swiper-wrapper">
								...
								foreach ( $images as $image ) :
									...
									<div class="alben-absence-slider__slide swiper-slide">
										...
										<div class="alben-absence-slider__footer">
											<?php if ( $name || $place ) : ?>
							...
							<div class="alben-absence-slider__nav-section flex aic fwrap absolute">
								<button
